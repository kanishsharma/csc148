...
def test_contains_one_item() -> None:
    """Test LinkedList.__contains__ on one item in a list"""
    lst = LinkedList()
    node1 = _Node(1)
    node2 = _Node(1)
    node3 = _Node(1)
...
def test_contains_first_item_only() -> None:
    """Test LinkedList.__contains__ with only the first item being in exit()the list"""
    lst = LinkedList()
    node1 = _Node(1)
    node2 = _Node(2)
    node3 = _Node(3)
