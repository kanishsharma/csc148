...
class Tree:
    ...
    def num_negatives(self) -> int:
        ...
        if self.is_empty():
            ...
            if self._root < 0:
                neg_counter += 1
            for subtree in self._subtrees:
                neg_counter += subtree.num_negatives()
            return neg_counter
    ...
    def maximum(self: Tree) -> int:
        ...
        if self.is_empty():
            ...
            current_max = 0
            for subtree in self._subtrees:
                max_return = subtree.maximum()
                if max_return > current_max:
                    current_max = max_return
            return current_max
    ...
    def height(self: Tree) -> int:
        ...
        if self.is_empty():
            ...
            list_heights = []
            for subtree in self._subtrees:
                list_heights.append(subtree.height())
            return max(list_heights) + height
